...
print_args <- function(deep_max, b, classifier, param){
  library(stringr)
  folder = paste(deep_max, b, "/best_expr/",sep='')
  name = paste("*", classifier, param, "*",sep='')
  files  = list.files(path = folder, pattern = name)
...
print_args_all <- function(deep_max, b){
  ...
  abline(v=24, lty = 2, col = 'blue')
  abline(v=30, lty = 1, col = 'green')
  abline(v=36, lty = 2, col = 'blue')
  abline(v=42, lty = 2, col = 'blue')
  abline(v=48, lty = 2, col = 'blue')
  abline(v=54, lty = 2, col = 'blue')
  abline(v=60, lty = 1, col = 'green')
  abline(v=66, lty = 2, col = 'blue')
  abline(v=72, lty = 2, col = 'blue')
  ...
  text(51, 900, "D4", font =2, col = 'blue')
  text(57, 900, "D5", font =2, col = 'blue')
  text(63, 900, "D1", font =2, col = 'blue')
  text(69, 900, "D2", font =2, col = 'blue')
  text(75, 900, "D3", font =2, col = 'blue')
  text(81, 900, "D4", font =2, col = 'blue')
  text(87, 900, "D5", font =2, col = 'blue')
...
print_dims_all <- function(deep_max, b){
  ...
  args_counter <- matrix(nrow = 30, ncol = 2)
  args_counter[,2] <- 0
  for(i in 1:30){
    args_counter[i,1] <- paste('ARG', i-1, sep = '')
  }
  ...
  barplot(as.numeric(args_counter[,2]), xlab = 'Número de atributos',main = 'Número dos atributos após a redução de dimensinalidade com GP', names = as.character(c(1:30)), ylab = 'Número de ocorrências')
  return(args_counter)
}
...
deep_max = 'SleepEEG/Exp/T10_2'
b = 'b'
classifier = 'nb'
param = ''

args = print_args_all(deep_max,'b')
dims = print_dims_all(deep_max,'b')
