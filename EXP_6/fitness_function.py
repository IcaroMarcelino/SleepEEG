...
def knn_feature_selection(individual, K, X_train, y_train, X_test, y_test, pset):
...
def eval_tree(individual, K, X_train, y_train, X_test, y_test, pset, opt_vars):
	pred = knn_feature_selection(individual, K, X_train, y_train, X_test, y_test, pset)
...
def performance(individual, K, X_train, y_train, X_test, y_test, pset):
	pred = knn_feature_selection(individual, K, X_train, y_train, X_test, y_test, pset)
