...
def import_all_data(files_paths, rand, test_percent):
	...
	return np.array(X_train), np.array(y_train), np.array(X_test), np.array(y_test), n_att
...
def main(NEXEC, K, TAM_MAX, NGEN, CXPB, MUTPB, NPOP, train_percent, verb, FILE_NAME):
	...
	files = ['pca_ex1.csv', 'pca_ex2.csv', 'pca_ex3.csv', 'pca_ex4.csv', 'pca_ex5.csv', 'pca_ex6.csv', 'pca_ex7.csv', 'pca_ex8.csv']
	X_train, y_train, X_test, y_test, n_att = import_all_data(files,1,.3)
